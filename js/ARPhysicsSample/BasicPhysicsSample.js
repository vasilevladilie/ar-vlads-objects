...
var BasicARPhysicsSample = createReactClass({
    ...
    return (
      <ViroNode position={this.state.planePosition}>
        ...
        <ViroController reticleVisibility={true}
          ...
          ref={(component)=>{this.controllerRef = component}}
          onClick={() => {}}
        />
  ...
  _resetScene() {
    ...
    // console.log("_resetScene");
    textContainer += "Reset Scene";
  ...
  _toggleCollisionBox(){
   //  console.log("toggleCollisionBox");
    textContainer += "toggleCollisionBox"
    this.state.text = textContainer;

    this.setState({showCollisionBox:!this.state.showCollisionBox});
  },

  _toggleControllerInteraction(){
    // console.log("_toggleControllerInteraction");
    // this.state.text = "_toggleControllerInteraction";
    textContainer += "toggleControllerInteraction"
...
//    console.log("Viro box has collided on the " + collidedTag);
    ...
    if (collidedTag == "BallTag"){
      textContainer += "Viro box has collided on the " + collidedTag + " ground_hit";
  ...
  _addCube(){
    textContainer += "_addCube_" + this.state.totalCubes;
